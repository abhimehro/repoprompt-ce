...
struct WorkspaceApprovalOverlayView: View {
    ...
    private var actionsSection: some View {
        HStack(spacing: 12) {
            ...
            .accessibilityLabel("Deny \(request.operation.displayName.lowercased()) operation")
            ...
            .accessibilityLabel("\(alwaysAllow ? "Always Allow" : "Allow Once") \(request.operation.displayName.lowercased()) operation")
        }
        .padding(20)
    }
