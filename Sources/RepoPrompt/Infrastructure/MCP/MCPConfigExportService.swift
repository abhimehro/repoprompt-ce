...
actor MCPConfigExportService {
    ...
    func prepareStableWrapperConfigFile() throws -> URL {
        ...
        let tempURL = configDirectoryURL.appendingPathComponent(".temp-\(UUID().uuidString)", isDirectory: false)
    ...
    private func makeLease(prefix: String, contents: String) throws -> MCPConfigLease {
        ...
        let tempURL = launchConfigDirectoryURL.appendingPathComponent(".temp-\(UUID().uuidString)", isDirectory: false)
