...
actor MCPConfigExportService {
    ...
    func prepareStableWrapperConfigFile() throws -> URL {
        ...
        guard let data = configJSON.data(using: .utf8) else { throw CocoaError(.fileWriteInapplicableStringEncoding) }
    ...
    private func makeLease(prefix: String, contents: String) throws -> MCPConfigLease {
        ...
        guard let data = contents.data(using: .utf8) else { throw CocoaError(.fileWriteInapplicableStringEncoding) }
