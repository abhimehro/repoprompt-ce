...
extension ToolOutputFormatter {
    ...
    private static let displayFormatterMediumShort: DateFormatter = {
    ...
    private static let displayFormatterDateOnly: DateFormatter = {
        let display = DateFormatter()
    ...
    private static func formatGitDate(_ isoDate: String) -> String {
        ...
        if let date = isoFormatterWithFractional.date(from: isoDate) {
            return displayFormatterMediumShort.string(from: date)
        }
        // Try without fractional seconds
        if let date = isoFormatterStandard.date(from: isoDate) {
            return displayFormatterMediumShort.string(from: date)
        }
        return isoDate
    }
    ...
    private static func formatGitDateShort(_ isoDate: String) -> String {
        ...
        if let date = isoFormatterWithFractional.date(from: isoDate) {
            return displayFormatterDateOnly.string(from: date)
        }
        if let date = isoFormatterStandard.date(from: isoDate) {
            return displayFormatterDateOnly.string(from: date)
        }
