...
class Changelog {
    // ⚡ Bolt: Shared instance to avoid expensive redundant allocations
    static let dateFormatter = ISO8601DateFormatter()
    static let current = Version(
        id: "2.1.24",
        buildNumber: 326,
        date: Self.dateFormatter.date(from: "2026-05-09T00:00:00Z") ?? Date(),
        changes: """
        ## [2.1.24] - 2026-05-09
    ...
    static let _210 = Version(
        id: "2.1.0",
        buildNumber: 302,
        date: Self.dateFormatter.date(from: "2026-04-02T00:00:00Z") ?? Date(),
        changes: """
        ## [2.1.0] - 2026-04-02
    ...
    static let history: [Version] = [
        ...
        Version(
            id: "2.1.23",
            buildNumber: 325,
            date: Self.dateFormatter.date(from: "2026-05-08T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.23] - 2026-05-08
        ...
        Version(
            id: "2.1.22",
            buildNumber: 324,
            date: Self.dateFormatter.date(from: "2026-05-07T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.22] - 2026-05-07
        ...
        Version(
            id: "2.1.21",
            buildNumber: 323,
            date: Self.dateFormatter.date(from: "2026-05-06T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.21] - 2026-05-06
        ...
        Version(
            id: "2.1.20",
            buildNumber: 322,
            date: Self.dateFormatter.date(from: "2026-04-24T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.20] - 2026-04-24
        ...
        Version(
            id: "2.1.18",
            buildNumber: 320,
            date: Self.dateFormatter.date(from: "2026-04-23T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.18] - 2026-04-23
        ...
        Version(
            id: "2.1.17",
            buildNumber: 319,
            date: Self.dateFormatter.date(from: "2026-04-22T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.17] - 2026-04-22
        ...
        Version(
            id: "2.1.16",
            buildNumber: 318,
            date: Self.dateFormatter.date(from: "2026-04-21T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.16] - 2026-04-21
        ...
        Version(
            id: "2.1.14",
            buildNumber: 316,
            date: Self.dateFormatter.date(from: "2026-04-20T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.14] - 2026-04-20
        ...
        Version(
            id: "2.1.13",
            buildNumber: 315,
            date: Self.dateFormatter.date(from: "2026-04-17T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.13] - 2026-04-17
        ...
        Version(
            id: "2.1.11",
            buildNumber: 313,
            date: Self.dateFormatter.date(from: "2026-04-16T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.11] - 2026-04-16
        ...
        Version(
            id: "2.1.10",
            buildNumber: 312,
            date: Self.dateFormatter.date(from: "2026-04-15T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.10] - 2026-04-15
        ...
        Version(
            id: "2.1.9",
            buildNumber: 311,
            date: Self.dateFormatter.date(from: "2026-04-14T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.9] - 2026-04-14
        ...
        Version(
            id: "2.1.7",
            buildNumber: 309,
            date: Self.dateFormatter.date(from: "2026-04-13T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.7] - 2026-04-13
        ...
        Version(
            id: "2.1.6",
            buildNumber: 308,
            date: Self.dateFormatter.date(from: "2026-04-10T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.6] - 2026-04-10
        ...
        Version(
            id: "2.1.5",
            buildNumber: 307,
            date: Self.dateFormatter.date(from: "2026-04-08T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.5] - 2026-04-08
        ...
        Version(
            id: "2.1.3",
            buildNumber: 305,
            date: Self.dateFormatter.date(from: "2026-04-04T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.3] - 2026-04-04
        ...
        Version(
            id: "2.1.2",
            buildNumber: 304,
            date: Self.dateFormatter.date(from: "2026-04-03T00:00:00Z") ?? Date(),
            changes: """
            ## [2.1.2] - 2026-04-03
        ...
        Version(
            id: "2.0.31",
            buildNumber: 301,
            date: Self.dateFormatter.date(from: "2026-03-30T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.31] - 2026-03-30
        ...
        Version(
            id: "2.0.29",
            buildNumber: 299,
            date: Self.dateFormatter.date(from: "2026-03-27T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.29] - 2026-03-27
        ...
        Version(
            id: "2.0.26",
            buildNumber: 296,
            date: Self.dateFormatter.date(from: "2026-03-26T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.26] - 2026-03-26
        ...
        Version(
            id: "2.0.25",
            buildNumber: 295,
            date: Self.dateFormatter.date(from: "2026-03-23T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.25] - 2026-03-23
        ...
        Version(
            id: "2.0.24",
            buildNumber: 294,
            date: Self.dateFormatter.date(from: "2026-03-20T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.24] - 2026-03-20
        ...
        Version(
            id: "2.0.23",
            buildNumber: 293,
            date: Self.dateFormatter.date(from: "2026-03-19T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.23] - 2026-03-19
        ...
        Version(
            id: "2.0.22",
            buildNumber: 292,
            date: Self.dateFormatter.date(from: "2026-03-18T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.22] - 2026-03-18
        ...
        Version(
            id: "2.0.21",
            buildNumber: 291,
            date: Self.dateFormatter.date(from: "2026-03-17T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.21] - 2026-03-17
        ...
        Version(
            id: "2.0.20",
            buildNumber: 290,
            date: Self.dateFormatter.date(from: "2026-03-12T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.20] - 2026-03-12
        ...
        Version(
            id: "2.0.18",
            buildNumber: 288,
            date: Self.dateFormatter.date(from: "2026-03-10T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.18] - 2026-03-10
        ...
        Version(
            id: "2.0.16",
            buildNumber: 286,
            date: Self.dateFormatter.date(from: "2026-03-05T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.16] - 2026-03-05
        ...
        Version(
            id: "2.0.14",
            buildNumber: 284,
            date: Self.dateFormatter.date(from: "2026-03-04T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.14] - 2026-03-04
        ...
        Version(
            id: "2.0.13",
            buildNumber: 283,
            date: Self.dateFormatter.date(from: "2026-03-02T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.13] - 2026-03-02
        ...
        Version(
            id: "2.0.12",
            buildNumber: 282,
            date: Self.dateFormatter.date(from: "2026-03-01T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.12] - 2026-03-01
        ...
        Version(
            id: "2.0.11",
            buildNumber: 281,
            date: Self.dateFormatter.date(from: "2026-02-27T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.11] - 2026-02-27
        ...
        Version(
            id: "2.0.10",
            buildNumber: 280,
            date: Self.dateFormatter.date(from: "2026-02-25T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.10] - 2026-02-25
        ...
        Version(
            id: "2.0.9",
            buildNumber: 279,
            date: Self.dateFormatter.date(from: "2026-02-23T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.9] - 2026-02-23
        ...
        Version(
            id: "2.0.8",
            buildNumber: 278,
            date: Self.dateFormatter.date(from: "2026-02-18T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.8] - 2026-02-18
        ...
        Version(
            id: "2.0.4",
            buildNumber: 274,
            date: Self.dateFormatter.date(from: "2026-02-14T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.4] - 2026-02-14
        ...
        Version(
            id: "2.0.2",
            buildNumber: 272,
            date: Self.dateFormatter.date(from: "2026-02-13T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.2] - 2026-02-13
        ...
        Version(
            id: "2.0.1",
            buildNumber: 271,
            date: Self.dateFormatter.date(from: "2026-02-11T00:00:00Z") ?? Date(),
            changes: """
            ## [2.0.1] - 2026-02-11
        ...
        Version(
            id: "1.6.14",
            buildNumber: 269,
            date: Self.dateFormatter.date(from: "2026-02-06T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.14] - 2026-02-06
        ...
        Version(
            id: "1.6.13",
            buildNumber: 268,
            date: Self.dateFormatter.date(from: "2026-02-05T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.13] - 2026-02-05
        ...
        Version(
            id: "1.6.12",
            buildNumber: 266,
            date: Self.dateFormatter.date(from: "2026-02-04T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.12] - 2026-02-04
        ...
        Version(
            id: "1.6.11",
            buildNumber: 265,
            date: Self.dateFormatter.date(from: "2026-02-02T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.11] - 2026-02-02
        ...
        Version(
            id: "1.6.10",
            buildNumber: 264,
            date: Self.dateFormatter.date(from: "2026-02-01T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.10] - 2026-02-01
        ...
        Version(
            id: "1.6.9",
            buildNumber: 263,
            date: Self.dateFormatter.date(from: "2026-01-31T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.9] - 2026-01-31
        ...
        Version(
            id: "1.6.8",
            buildNumber: 262,
            date: Self.dateFormatter.date(from: "2026-01-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.8] - 2026-01-28
        ...
        Version(
            id: "1.6.7",
            buildNumber: 261,
            date: Self.dateFormatter.date(from: "2026-01-27T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.7] - 2026-01-27
        ...
        Version(
            id: "1.6.5",
            buildNumber: 259,
            date: Self.dateFormatter.date(from: "2026-01-26T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.5] - 2026-01-26
        ...
        Version(
            id: "1.6.4",
            buildNumber: 258,
            date: Self.dateFormatter.date(from: "2026-01-23T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.4] - 2026-01-23
        ...
        Version(
            id: "1.6.1",
            buildNumber: 255,
            date: Self.dateFormatter.date(from: "2026-01-22T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.1] - 2026-01-22
        ...
        Version(
            id: "1.6.0",
            buildNumber: 254,
            date: Self.dateFormatter.date(from: "2026-01-20T00:00:00Z") ?? Date(),
            changes: """
            ## [1.6.0] - 2026-01-20
        ...
        Version(
            id: "1.5.68",
            buildNumber: 253,
            date: Self.dateFormatter.date(from: "2026-01-16T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.68] - 2026-01-16
        ...
        Version(
            id: "1.5.67",
            buildNumber: 251,
            date: Self.dateFormatter.date(from: "2026-01-13T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.67] - 2026-01-13
        ...
        Version(
            id: "1.5.66",
            buildNumber: 250,
            date: Self.dateFormatter.date(from: "2026-01-12T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.66] - 2026-01-12
        ...
        Version(
            id: "1.5.65",
            buildNumber: 249,
            date: Self.dateFormatter.date(from: "2026-01-08T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.65] - 2026-01-08
        ...
        Version(
            id: "1.5.63",
            buildNumber: 247,
            date: Self.dateFormatter.date(from: "2026-01-07T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.63] - 2026-01-07
        ...
        Version(
            id: "1.5.62",
            buildNumber: 246,
            date: Self.dateFormatter.date(from: "2026-01-05T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.62] - 2026-01-05
        ...
        Version(
            id: "1.5.61",
            buildNumber: 243,
            date: Self.dateFormatter.date(from: "2026-01-01T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.61] - 2026-01-01
        ...
        Version(
            id: "1.5.60",
            buildNumber: 242,
            date: Self.dateFormatter.date(from: "2025-12-22T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.60] - 2025-12-22
        ...
        Version(
            id: "1.5.59",
            buildNumber: 241,
            date: Self.dateFormatter.date(from: "2025-12-19T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.59] - 2025-12-19
        ...
        Version(
            id: "1.5.57",
            buildNumber: 239,
            date: Self.dateFormatter.date(from: "2025-12-18T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.57] - 2025-12-18
        ...
        Version(
            id: "1.5.56",
            buildNumber: 238,
            date: Self.dateFormatter.date(from: "2025-12-11T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.56] - 2025-12-11
        ...
        Version(
            id: "1.5.54",
            buildNumber: 236,
            date: Self.dateFormatter.date(from: "2025-12-10T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.54] - 2025-12-10
        ...
        Version(
            id: "1.5.53",
            buildNumber: 235,
            date: Self.dateFormatter.date(from: "2025-12-08T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.53] - 2025-12-08
        ...
        Version(
            id: "1.5.52",
            buildNumber: 234,
            date: Self.dateFormatter.date(from: "2025-12-07T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.52] - 2025-12-07
        ...
        Version(
            id: "1.5.51",
            buildNumber: 233,
            date: Self.dateFormatter.date(from: "2025-12-06T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.51] - 2025-12-06
        ...
        Version(
            id: "1.5.48",
            buildNumber: 211,
            date: Self.dateFormatter.date(from: "2025-12-05T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.48] - 2025-12-05
        ...
        Version(
            id: "1.5.46",
            buildNumber: 209,
            date: Self.dateFormatter.date(from: "2025-12-03T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.46] - 2025-12-03
        ...
        Version(
            id: "1.5.44",
            buildNumber: 207,
            date: Self.dateFormatter.date(from: "2025-11-29T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.44] - 2025-11-29
        ...
        Version(
            id: "1.5.43",
            buildNumber: 206,
            date: Self.dateFormatter.date(from: "2025-11-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.43] - 2025-11-28
        ...
        Version(
            id: "1.5.41",
            buildNumber: 204,
            date: Self.dateFormatter.date(from: "2025-11-26T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.41] - 2025-11-26
        ...
        Version(
            id: "1.5.40",
            buildNumber: 203,
            date: Self.dateFormatter.date(from: "2025-11-24T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.40] - 2025-11-24
        ...
        Version(
            id: "1.5.39",
            buildNumber: 202,
            date: Self.dateFormatter.date(from: "2025-11-19T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.39] - 2025-11-19
        ...
        Version(
            id: "1.5.38",
            buildNumber: 201,
            date: Self.dateFormatter.date(from: "2025-11-18T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.38] - 2025-11-18
        ...
        Version(
            id: "1.5.37",
            buildNumber: 200,
            date: Self.dateFormatter.date(from: "2025-11-17T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.37] - 2025-11-17
        ...
        Version(
            id: "1.5.36",
            buildNumber: 199,
            date: Self.dateFormatter.date(from: "2025-11-14T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.36] - 2025-11-14
        ...
        Version(
            id: "1.5.34",
            buildNumber: 197,
            date: Self.dateFormatter.date(from: "2025-11-13T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.34] - 2025-11-13
        ...
        Version(
            id: "1.5.33",
            buildNumber: 196,
            date: Self.dateFormatter.date(from: "2025-11-12T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.33] - 2025-11-12
        ...
        Version(
            id: "1.5.32",
            buildNumber: 195,
            date: Self.dateFormatter.date(from: "2025-11-11T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.32] - 2025-11-11
        ...
        Version(
            id: "1.5.31",
            buildNumber: 194,
            date: Self.dateFormatter.date(from: "2025-11-10T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.31] - 2025-11-10
        ...
        Version(
            id: "1.5.27",
            buildNumber: 190,
            date: Self.dateFormatter.date(from: "2025-11-09T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.27] - 2025-11-09
        ...
        Version(
            id: "1.5.25",
            buildNumber: 188,
            date: Self.dateFormatter.date(from: "2025-11-08T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.25] - 2025-11-08
        ...
        Version(
            id: "1.5.22",
            buildNumber: 185,
            date: Self.dateFormatter.date(from: "2025-11-07T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.22] - 2025-11-07
        ...
        Version(
            id: "1.5.21",
            buildNumber: 184,
            date: Self.dateFormatter.date(from: "2025-11-04T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.21] - 2025-11-04
        ...
        Version(
            id: "1.5.20",
            buildNumber: 183,
            date: Self.dateFormatter.date(from: "2025-11-02T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.20] - 2025-11-02
        ...
        Version(
            id: "1.5.19",
            buildNumber: 182,
            date: Self.dateFormatter.date(from: "2025-10-31T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.19] - 2025-10-31
        ...
        Version(
            id: "1.5.18",
            buildNumber: 181,
            date: Self.dateFormatter.date(from: "2025-10-30T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.18] - 2025-10-30
        ...
        Version(
            id: "1.5.16",
            buildNumber: 179,
            date: Self.dateFormatter.date(from: "2025-10-29T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.16] - 2025-10-29
        ...
        Version(
            id: "1.5.14",
            buildNumber: 177,
            date: Self.dateFormatter.date(from: "2025-10-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.14] - 2025-10-28
        ...
        Version(
            id: "1.5.13",
            buildNumber: 176,
            date: Self.dateFormatter.date(from: "2025-10-26T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.13] - 2025-10-26
        ...
        Version(
            id: "1.5.10",
            buildNumber: 173,
            date: Self.dateFormatter.date(from: "2025-10-25T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.10] - 2025-10-25
        ...
        Version(
            id: "1.5.6",
            buildNumber: 169,
            date: Self.dateFormatter.date(from: "2025-10-24T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.6] - 2025-10-24
        ...
        Version(
            id: "1.5.5",
            buildNumber: 168,
            date: Self.dateFormatter.date(from: "2025-10-21T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.5] - 2025-10-21
        ...
        Version(
            id: "1.5.4",
            buildNumber: 167,
            date: Self.dateFormatter.date(from: "2025-10-20T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.4] - 2025-10-20
        ...
        Version(
            id: "1.5.2",
            buildNumber: 165,
            date: Self.dateFormatter.date(from: "2025-10-17T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5.2] - 2025-10-17
        ...
        Version(
            id: "1.5",
            buildNumber: 163,
            date: Self.dateFormatter.date(from: "2025-10-16T00:00:00Z") ?? Date(),
            changes: """
            ## [1.5] - 2025-10-16
        ...
        Version(
            id: "1.4.27",
            buildNumber: 162,
            date: Self.dateFormatter.date(from: "2025-10-07T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.27] - 2025-10-07
        ...
        Version(
            id: "1.4.26",
            buildNumber: 161,
            date: Self.dateFormatter.date(from: "2025-09-30T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.26] - 2025-09-30
        ...
        Version(
            id: "1.4.25",
            buildNumber: 160,
            date: Self.dateFormatter.date(from: "2025-09-29T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.25] - 2025-09-29
        ...
        Version(
            id: "1.4.24",
            buildNumber: 159,
            date: Self.dateFormatter.date(from: "2025-09-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.24] - 2025-09-28
        ...
        Version(
            id: "1.4.23",
            buildNumber: 158,
            date: Self.dateFormatter.date(from: "2025-09-27T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.23] - 2025-09-27
        ...
        Version(
            id: "1.4.22",
            buildNumber: 157,
            date: Self.dateFormatter.date(from: "2025-09-25T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.22] - 2025-09-25
        ...
        Version(
            id: "1.4.21",
            buildNumber: 156,
            date: Self.dateFormatter.date(from: "2025-09-24T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.21] - 2025-09-24
        ...
        Version(
            id: "1.4.20",
            buildNumber: 155,
            date: Self.dateFormatter.date(from: "2025-09-22T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.20] - 2025-09-22
        ...
        Version(
            id: "1.4.19",
            buildNumber: 154,
            date: Self.dateFormatter.date(from: "2025-09-19T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.19] - 2025-09-19
        ...
        Version(
            id: "1.4.18",
            buildNumber: 153,
            date: Self.dateFormatter.date(from: "2025-09-18T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.18] - 2025-09-18
        ...
        Version(
            id: "1.4.17",
            buildNumber: 152,
            date: Self.dateFormatter.date(from: "2025-09-26T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.17] - 2025-09-26
        ...
        Version(
            id: "1.4.16",
            buildNumber: 151,
            date: Self.dateFormatter.date(from: "2025-09-16T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.16] - 2025-09-16
        ...
        Version(
            id: "1.4.15",
            buildNumber: 150,
            date: Self.dateFormatter.date(from: "2025-09-13T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.15] - 2025-09-13
        ...
        Version(
            id: "1.4.14",
            buildNumber: 149,
            date: Self.dateFormatter.date(from: "2025-09-12T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.14] - 2025-09-12
        ...
        Version(
            id: "1.4.13",
            buildNumber: 148,
            date: Self.dateFormatter.date(from: "2025-09-11T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.13] - 2025-09-11
        ...
        Version(
            id: "1.4.12",
            buildNumber: 147,
            date: Self.dateFormatter.date(from: "2025-09-09T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.12] - 2025-09-09
        ...
        Version(
            id: "1.4.11",
            buildNumber: 146,
            date: Self.dateFormatter.date(from: "2025-09-08T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.11] - 2025-09-08
        ...
        Version(
            id: "1.4.10",
            buildNumber: 145,
            date: Self.dateFormatter.date(from: "2025-09-04T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.10] - 2025-09-04
        ...
        Version(
            id: "1.4.9",
            buildNumber: 144,
            date: Self.dateFormatter.date(from: "2025-09-03T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.9] - 2025-09-03
        ...
        Version(
            id: "1.4.8",
            buildNumber: 143,
            date: Self.dateFormatter.date(from: "2025-09-15T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.8] - 2025-09
        ...
        Version(
            id: "1.4.7",
            buildNumber: 142,
            date: Self.dateFormatter.date(from: "2025-09-01T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.7] - 2025-09-01
        ...
        Version(
            id: "1.4.6",
            buildNumber: 141,
            date: Self.dateFormatter.date(from: "2025-08-29T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.6] - 2025-08-29
        ...
        Version(
            id: "1.4.2",
            buildNumber: 137,
            date: Self.dateFormatter.date(from: "2025-08-27T00:00:00Z") ?? Date(),
            changes: """
            ## [1.4.2] - 2025-08-27
        ...
        Version(
            id: "1.4.0",
            buildNumber: 135,
            date: Self.dateFormatter.date(from: "2025-08-25T00:00:00Z") ?? Date(),
            changes: """
        ...
        Version(
            id: "1.3.50",
            buildNumber: 134,
            date: Self.dateFormatter.date(from: "2025-08-19T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.50] - 2025-08-19
        ...
        Version(
            id: "1.3.49",
            buildNumber: 133,
            date: Self.dateFormatter.date(from: "2025-08-18T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.49] - 2025-08-18
        ...
        Version(
            id: "1.3.47",
            buildNumber: 131,
            date: Self.dateFormatter.date(from: "2025-08-17T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.47] - 2025-08-17
        ...
        Version(
            id: "1.3.45",
            buildNumber: 129,
            date: Self.dateFormatter.date(from: "2025-08-16T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.45] - 2025-08-16
        ...
        Version(
            id: "1.3.44",
            buildNumber: 128,
            date: Self.dateFormatter.date(from: "2025-08-12T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.44] - 2025-08-12
        ...
        Version(
            id: "1.3.41",
            buildNumber: 125,
            date: Self.dateFormatter.date(from: "2025-08-11T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.41] - 2025-08-11
        ...
        Version(
            id: "1.3.39",
            buildNumber: 123,
            date: Self.dateFormatter.date(from: "2025-08-06T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.39] - 2025-08-06
        ...
        Version(
            id: "1.3.38",
            buildNumber: 122,
            date: Self.dateFormatter.date(from: "2025-08-04T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.38] - 2025-08-04
        ...
        Version(
            id: "1.3.37",
            buildNumber: 121,
            date: Self.dateFormatter.date(from: "2025-08-01T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.37] - 2025-08-01
        ...
        Version(
            id: "1.3.33",
            buildNumber: 117,
            date: Self.dateFormatter.date(from: "2025-07-31T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.33] - 2025-07-31
        ...
        Version(
            id: "1.3.27",
            buildNumber: 111,
            date: Self.dateFormatter.date(from: "2025-07-30T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.27] - 2025-07-30
        ...
        Version(
            id: "1.3.26",
            buildNumber: 110,
            date: Self.dateFormatter.date(from: "2025-07-29T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.26] - 2025-07-29
        ...
        Version(
            id: "1.3.25",
            buildNumber: 109,
            date: Self.dateFormatter.date(from: "2025-07-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.25] - 2025-07-28
        ...
        Version(
            id: "1.3.24",
            buildNumber: 108,
            date: Self.dateFormatter.date(from: "2024-07-28T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.24] - 2024-07-28
        ...
        Version(
            id: "1.3.23",
            buildNumber: 107,
            date: Self.dateFormatter.date(from: "2024-07-24T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.23] - 2024-07-24
        ...
        Version(
            id: "1.3.21",
            buildNumber: 105,
            date: Self.dateFormatter.date(from: "2024-07-22T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.21] - 2024-07-22
        ...
        Version(
            id: "1.3.20",
            buildNumber: 104,
            date: Self.dateFormatter.date(from: "2024-07-21T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.20] - 2024-07-21
        ...
        Version(
            id: "1.3.19",
            buildNumber: 103,
            date: Self.dateFormatter.date(from: "2024-07-17T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.19] - 2024-07-17
        ...
        Version(
            id: "1.3.18",
            buildNumber: 102,
            date: Self.dateFormatter.date(from: "2025-07-16T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.18] - 2025-07-16
        ...
        Version(
            id: "1.3.16",
            buildNumber: 100,
            date: Self.dateFormatter.date(from: "2025-07-14T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.16] - 2025-07-14
        ...
        Version(
            id: "1.3.15",
            buildNumber: 99,
            date: Self.dateFormatter.date(from: "2025-07-11T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.15] - 2025-07-11
        ...
        Version(
            id: "1.3.14",
            buildNumber: 98,
            date: Self.dateFormatter.date(from: "2025-07-07T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.14] - 2025-07-07
        ...
        Version(
            id: "1.3.13",
            buildNumber: 97,
            date: Self.dateFormatter.date(from: "2024-07-04T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.13] - 2024-07-04
        ...
        Version(
            id: "1.3.12",
            buildNumber: 96,
            date: Self.dateFormatter.date(from: "2024-07-02T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.12] - 2024-07-02
        ...
        Version(
            id: "1.3.11",
            buildNumber: 95,
            date: Self.dateFormatter.date(from: "2024-07-01T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.11] - 2024-07-01
        ...
        Version(
            id: "1.3.10",
            buildNumber: 94,
            date: Self.dateFormatter.date(from: "2024-06-30T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.10] - 2024-06-30
        ...
        Version(
            id: "1.3.9",
            buildNumber: 93,
            date: Self.dateFormatter.date(from: "2024-06-27T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.9] - 2024-06-27
        ...
        Version(
            id: "1.3.7",
            buildNumber: 91,
            date: Self.dateFormatter.date(from: "2024-06-26T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.7] - 2024-06-26
        ...
        Version(
            id: "1.3.4",
            buildNumber: 88,
            date: Self.dateFormatter.date(from: "2024-06-25T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.4] - 2024-06-25
        ...
        Version(
            id: "1.3.3",
            buildNumber: 87,
            date: Self.dateFormatter.date(from: "2024-06-24T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3.3] - 2024-06-24
        ...
        Version(
            id: "1.3",
            buildNumber: 84,
            date: Self.dateFormatter.date(from: "2024-06-23T00:00:00Z") ?? Date(),
            changes: """
            ## [1.3] - Major Release
