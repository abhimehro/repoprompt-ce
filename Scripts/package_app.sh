...
APP_NAME="${APP_NAME:-RepoPrompt}"
DISPLAY_NAME="${DISPLAY_NAME:-RepoPrompt CE}"
BASE_BUNDLE_ID="${BUNDLE_ID:-com.pvncher.repoprompt.ce}"
MARKETING_VERSION="${MARKETING_VERSION:-0.1.0}"
BUILD_NUMBER="${BUILD_NUMBER:-1}"
SIGNING_TEAM_ID="${SIGNING_TEAM_ID:-648A27MST5}"
